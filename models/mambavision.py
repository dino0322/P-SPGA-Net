...
class MambaVisionForImageClassification_v2(nn.Module):
    """MambaVision wrapper with DeepSAFEModel structure"""
    ...
    def __init__(self, num_labels=2, img_size=224, patch_size=16, hidden_dim=512,
        ...
        # Feature extractor (MambaVision backbone)
        self.feature_extractor = MambaVision(
            dim=config['dim'],
            in_dim=config['in_dim'],
            depths=config['depths'],
            window_size=config['window_size'],
        ...
        # SAFE module
        self.p_module = P_Module(self.cbam_channels, out_channels=64)
        ...
        # FC layers (DeepSAFEModel structure)
        ...
        if num_labels == 1:
            ...
            self.fc_out = nn.Linear(256, num_labels)
